" Vim color file
" Converted from Textmate theme Coda using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi MatchParen ctermfg=0 ctermbg=NONE cterm=underline guifg=#656565 guibg=NONE gui=underline
hi StatusLine ctermfg=0 ctermbg=249 cterm=bold guifg=#656565 guibg=#b5b5b5 gui=bold
hi StatusLineNC ctermfg=0 ctermbg=249 cterm=NONE guifg=#656565 guibg=#b5b5b5 gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=153 cterm=NONE guifg=NONE guibg=#a7caff gui=NONE
hi IncSearch ctermfg=15 ctermbg=208 cterm=NONE guifg=#ffffff guibg=#ed7722 gui=NONE
...
hi Normal ctermfg=0 ctermbg=15 cterm=NONE guifg=#656565 guibg=#ffffff gui=NONE
hi Boolean ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
...
hi Define ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
hi DiffAdd ctermfg=0 ctermbg=149 cterm=bold guifg=#656565 guibg=#a1e85d gui=bold
hi DiffDelete ctermfg=203 ctermbg=NONE cterm=NONE guifg=#f25454 guibg=NONE gui=NONE
hi DiffChange ctermfg=0 ctermbg=152 cterm=NONE guifg=#656565 guibg=#b9cfe7 gui=NONE
hi DiffText ctermfg=0 ctermbg=74 cterm=bold guifg=#656565 guibg=#729fcf gui=bold
...
hi Keyword ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
...
hi Operator ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
hi PreProc ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
hi Special ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
...
hi Tag ctermfg=126 ctermbg=NONE cterm=NONE guifg=#a21297 guibg=NONE gui=NONE
hi Title ctermfg=0 ctermbg=NONE cterm=bold guifg=#656565 guibg=NONE gui=bold
...
hi rubyInclude ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
hi rubyGlobalVariable ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
...
hi rubyOperator ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
hi rubyException ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
...
hi erubyDelimiter ctermfg=160 ctermbg=NONE cterm=NONE guifg=#ea291c guibg=NONE gui=NONE
...
hi htmlTag ctermfg=126 ctermbg=NONE cterm=NONE guifg=#a21297 guibg=NONE gui=NONE
hi htmlEndTag ctermfg=126 ctermbg=NONE cterm=NONE guifg=#a21297 guibg=NONE gui=NONE
hi htmlTagName ctermfg=126 ctermbg=NONE cterm=NONE guifg=#a21297 guibg=NONE gui=NONE
hi htmlArg ctermfg=126 ctermbg=NONE cterm=NONE guifg=#a21297 guibg=NONE gui=NONE
...
hi yamlKey ctermfg=126 ctermbg=NONE cterm=NONE guifg=#a21297 guibg=NONE gui=NONE
hi yamlAnchor ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
hi yamlAlias ctermfg=0 ctermbg=NONE cterm=NONE guifg=#656565 guibg=NONE gui=NONE
...
hi cssPseudoClassId ctermfg=130 ctermbg=NONE cterm=NONE guifg=#b14e00 guibg=NONE gui=NONE
hi cssClassName ctermfg=130 ctermbg=NONE cterm=NONE guifg=#b14e00 guibg=NONE gui=NONE
